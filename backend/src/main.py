...
# --- CORS configurado apenas para /api/* ---
CORS(
    app,
...
# 6) Cria tabelas (somente no fluxo de desenvolvimento)
with app.app_context():
    db.create_all()
    logging.info("Tabelas criadas com sucesso!")

# 7) Rotas de healthcheck e para servir o front-end
...
# 8) Desabilita cache em todas as respostas
@app.after_request
def disable_caching(response):
    ...
    # Se o cliente enviar If-None-Match/Since, força 200 em vez de 304
